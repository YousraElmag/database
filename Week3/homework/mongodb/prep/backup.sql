...
INSERT INTO `categories` VALUES (1,'Cake'),(5,'Gluten-Free'),(6,'Japanese'),(2,'No-Bake'),(4,'Vegan'),(3,'Vegetarian');
...
INSERT INTO `ingredients` VALUES (6,'Brussels Sprouts'),(12,'Butter'),(5,'Cherry Jam'),(1,'Condensed Milk'),(2,'Cream Cheese'),(16,'Eggs'),(13,'Flour'),(3,'Lemon Juice'),(11,'Macaroni'),(14,'Milk'),(10,'Olive Oil'),(8,'Pepper'),(4,'Pie Crust'),(9,'Salt'),(7,'Sesame Seeds'),(15,'Shredded Cheddar Cheese'),(17,'Soy Sauce'),(18,'Sugar');
...
INSERT INTO `recipe_categories` VALUES (1,1),(1,2),(1,3);
...
INSERT INTO `recipe_ingredients` VALUES (1,1,'1','can'),(1,2,'1','block'),(1,3,'3','tbsp'),(1,4,'1','unit'),(1,5,'0.5','cup');
...
CREATE TABLE `recipe_steps` (
  ...
  KEY `step_id` (`step_id`),
  CONSTRAINT `recipe_steps_ibfk_1` FOREIGN KEY (`recipe_id`) REFERENCES `recipes` (`recipe_id`),
  CONSTRAINT `recipe_steps_ibfk_2` FOREIGN KEY (`step_id`) REFERENCES `steps` (`step_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `recipe_steps` VALUES (1,1,1),(1,2,2),(1,3,3),(1,4,4),(1,5,5),(1,6,6);
...
INSERT INTO `recipes` VALUES (1,'No-Bake Cheesecake','A delicious no-bake cheesecake.');
...
CREATE TABLE `steps` (
  ...
  PRIMARY KEY (`step_id`),
  UNIQUE KEY `step_description` (`step_description`(255))
...
-- Dump completed on 2024-08-15 22:59:08
